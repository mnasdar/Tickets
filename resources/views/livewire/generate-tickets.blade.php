            ...
            @foreach ($data as $item)
                <tr>
                    ...
                    <td class="px-4 py-2 whitespace-nowrap">
                        <x-button-warning data-tooltip-target="tooltip-email{{ $item->id }}" wire:click=""
                            ...
                            <x-button-info data-tooltip-target="tooltip-print{{ $item->id }}" wire:click="printQr({{ $item->ticket_code }})"
                                wire:loading.attr="disabled">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="size-6 w-4 h-4">
                                    <path stroke-linecap="round" stroke-linejoin="round"
