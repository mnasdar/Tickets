                ...
                <x-slot name="content">
                    ...
                    <div class="grid grid-cols-12 mt-4 sm:col-span-4">
                        ...
                        <div class="col-span-6">
                            ...
                            <x-input id="end_date" type="date" class="mt-1 block w-50" wire:model.defer="form.end_date" />
                            <x-input-error for="form.end_date" class="mt-2" />
                        </div>
                    </div>
                    <div class="mt-4 col-span-6 sm:col-span-4">
                        <x-label for="location" value="{{ __('Location') }}" />
                        <x-input id="location" type="text" class="mt-1 block w-full" wire:model.defer="form.location" />
